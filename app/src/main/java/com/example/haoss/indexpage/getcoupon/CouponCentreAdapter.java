...
public class CouponCentreAdapter extends BaseAdapter {
    ...
    private List<RespCoupon.Coupon> list;
    private OClick oClick;  //点击监听

    public CouponCentreAdapter(Context context, List<RespCoupon.Coupon> list, OClick oClick) {
        this.context = context;
        this.list = list;
        this.oClick = oClick;
    }

    public void fresh(List<RespCoupon.Coupon> list) {
        this.list = list;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        RespCoupon.Coupon couponInfo = list.get(position);
    ...
    class OnClickGet implements View.OnClickListener {
        ...
        RespCoupon.Coupon info;

        public OnClickGet(RespCoupon.Coupon info) {
            this.info = info;
        }
    ...
    //点击传递监听
    interface OClick {
        void onClick(RespCoupon.Coupon info);
    }
