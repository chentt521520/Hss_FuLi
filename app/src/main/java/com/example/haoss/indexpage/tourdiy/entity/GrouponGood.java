...
public class GrouponGood {
    ...
    private GoodsType StoreProductValue;
    ...
    public void setReplyChance(int replyChance) {
    ...
    public GoodsType getStoreProductValue() {
        return StoreProductValue;
    }

    public void setStoreProductValue(GoodsType storeProductValue) {
